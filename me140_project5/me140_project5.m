...
% Temperatures from Thermocouple Readings
% KEY: (Kendall please fill in with photo you took)
T1 =     [42.8 42.9 46.1 48.5 50.5 52.8 54.8 55.8 56.5];            % Celsius
T2 =     [42.5 45.8 45.8 48.4 50.3 51.9 53.3 53.9 54.3];
T3 =     [48.0 47.1 48.6 48.9 50.4 51.1 51.2 51.1 51.1];
T4 =     [48.0 47.2 48.2 48.9 50.4 51.1 51.2 51.1 51.1];
T5 =     [40.7 41.3 42.5 42.9 44.6 45.6 46.9 46.9 47.6];
